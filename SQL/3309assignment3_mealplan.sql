...
CREATE TABLE `mealplan` (
  ...
  `mealPlanName` varchar(100) COLLATE utf8mb4_cs_0900_ai_ci NOT NULL,
  `mealPlanUserId` int NOT NULL,
  `startDate` datetime NOT NULL,
  `endDate` datetime NOT NULL,
  PRIMARY KEY (`mealPlanId`,`mealPlanUserId`),
  UNIQUE KEY `mealPlanId_UNIQUE` (`mealPlanId`),
  KEY `mp.userId_idx` (`mealPlanUserId`),
  CONSTRAINT `mp.userId` FOREIGN KEY (`mealPlanUserId`) REFERENCES `user` (`userId`)

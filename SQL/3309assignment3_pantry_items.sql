...
CREATE TABLE `pantry_items` (
  ...
  KEY `pi.ingredientName_idx` (`pantryItemName`),
  CONSTRAINT `pi.ingredientName` FOREIGN KEY (`pantryItemName`) REFERENCES `ingredients` (`ingredientName`),
  CONSTRAINT `pi.userId` FOREIGN KEY (`pantryUsersId`) REFERENCES `user` (`userId`)
